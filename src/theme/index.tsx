...
export const DarkColors = {
  // Surfaces — neutral charcoal/near-black instead of navy-tinted.
  // Blue is reserved for brand accents below, not the base UI.
  background: '#08090C',
  surface: '#121317',
  surfaceAlt: '#1A1B20',
  card: '#17181D',
  ...
  // Brand — kept vivid so they still pop against the neutral surfaces
  navy: '#5A7FDE',
  navyDim: 'rgba(90, 127, 222, 0.16)',
  cobalt: '#6396F0',
  cobaltDim: 'rgba(99, 150, 240, 0.14)',
  green: '#4DCC5A',
  ...
  // Text — warm-neutral off-whites/grays instead of blue-white
  text: '#EDEDEF',
  textSoft: '#B8B9C0',
  muted: '#7A7B84',
  caption: '#4A4B52',
